  ...
  var infoWindow = new BMap.InfoWindow(''
      + '<div style="width: 250px">'
        ...
        + '<a href="https://github.com/wangding" target="_blank">'
          + '<img src="https://secure.gravatar.com/avatar/4e1b831efef47d65a762da5d5e89174c?s=250" alt="王顶" width="40px" height="40px" style="position: relative; top: -58px; left: 190px">'                                + '</a>'                                                             + '</div>', opts);
